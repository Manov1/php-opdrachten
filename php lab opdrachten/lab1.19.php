...
<html lang="nl">
<head>
    <title>lab 1.19</title>
</head>
<body>
<?php
    $vandaag = new DateTime("2019-01-01");
    ...
    // lab 1.19
    $kerstdatum = new DateTime("2021-12-25");
    echo "<br><br>Vandaag is: ".date_format($vandaag, "Y-m-d");
    $totkerst = date_diff($vandaag, $kerstdatum);
    echo "<br>U heeft nog: ".$totkerst->format("%R%a dagen tot kerst");
?>
</body>
</html>